...
const getProjectId = (project: MyProject) =>
  project.project_id ??
  project.projectId ??
  project.project ??
  project.id ??
...
const getProjectName = (project?: MyProject) =>
    ...
    >
      ...
      <div
        className={cn(
          ...
          isUser && "bg-primary text-primary-foreground shadow-primary/15",
          !isUser && "bg-white/90 text-foreground border border-border/60",
...
export const ChatInterface = () => {
  ...
  const activeProjectName =
    ...
    (projectId ? "Untitled project" : "Workspace");
  ...
  }, [dispatch, isCreatingProject, runPixel, trimmedProjectName]);
  ...
  return (
    <div className="relative h-full min-h-[32rem] overflow-hidden rounded-2xl border border-border/60 bg-gradient-to-br from-white via-amber-50/40 to-slate-50 p-6 shadow-sm">
          ...
          <footer className="border-t border-border/60 px-4 py-4">
            <div className="flex flex-col gap-3 sm:flex-row sm:items-end">
              <Textarea
                ...
                className="min-h-[3.25rem] max-h-60 flex-1 resize-none bg-white/90"
              />
              <Button
                disabled={isSendDisabled}
                onClick={handleSendMessage}
                className="h-9 shrink-0 px-4 sm:w-auto"
              >
                Send
              </Button>
            </div>
        ...
        <aside className="flex flex-col gap-5 overflow-y-auto rounded-xl border border-border/60 bg-white/80 p-4 shadow-sm backdrop-blur">
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center justify-between gap-2">
                ...
                <Dialog
                  ...
                  onOpenChange={setIsLoadProjectOpen}
                >
                  <DialogTrigger asChild>
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              readOnly
              aria-readonly
              className="cursor-not-allowed border-dashed bg-muted/40 text-muted-foreground focus-visible:ring-0"
            />
          </div>
            ...
            >
              ...
              <DialogContent>
                <DialogHeader>
                  ...
                  <DialogDescription>
                    Configure permission mode and select MCPs for this
                    workspace.
                  </DialogDescription>
                </DialogHeader>
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    {normalizedMcps.length === 0 ? (
                      ...
                      <div className="max-h-40 space-y-1 overflow-y-auto rounded-lg border border-border/60 bg-white/70 p-2">
                ...
                <div className="flex-1 min-h-0 space-y-4 overflow-y-auto pr-1">
                  {isLoadingSkills ? (
                    ...
                    <div className="flex h-full min-h-0 flex-col space-y-3">
                      <div className="flex items-center gap-2">
                        <div className="overflow-x-auto flex-1">
                          <div className="inline-flex min-w-full gap-2 rounded-lg border border-border/60 bg-muted/30 p-1">
                            {skillTabs.map((tab) => {
                              const isActive = tab.id === activeSkillTab?.id;
                              return (
                                <button
                                  key={tab.id}
                                  type="button"
                      ...
                      <section className="flex-1 min-h-0 overflow-hidden rounded-lg border border-border/60 bg-white/70 p-3">
                        {activeSkillTab ? (
                          <div className="flex h-full min-h-0 flex-col gap-3">
                            ...
                            {isActiveSkillEditing ? (
                              <>
                                <Textarea
                                  ...
                                  onChange={(event) => {
                                    setEditedSkillContentByTabId(
                                      (previous) => ({
                                        ...previous,
                                        [activeSkillTab.id]: event.target.value,
                                      }),
                                    );
                                    setSkillSaveError(null);
                                  }}
                                ...
                                <div className="min-h-0 flex-1 overflow-y-auto rounded-md border border-border/50 bg-white/80 p-3">
