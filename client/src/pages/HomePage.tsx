    ...
    <div className="relative flex h-full min-h-0 flex-col gap-4 lg:flex-row">
      ...
      >
        ...
        {projectId ? (
          <div
            className={cn(
              "flex min-h-0 flex-1 items-center justify-center overflow-auto pb-36",
          ...
          <div className="flex min-h-0 flex-1 flex-col items-center justify-center gap-2 px-6 pb-36 text-center">
